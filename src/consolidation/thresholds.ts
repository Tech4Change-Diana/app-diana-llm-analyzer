/**
 * DIANA — Limiares e calibração do Risk Engine.
 *
 * Portado de `app-diana-monitoring/src/risk-engine/thresholds.ts` (idêntico —
 * paridade numérica com o núcleo).
 *
 * ⚠️ MOCK / HEURÍSTICA DE MVP
 * Os valores abaixo são heurísticas de demonstração. NÃO representam um modelo
 * científico validado. Ver `docs/regras-de-negocio.md` §6.
 */
...
/** Piso/saída de confiança simulada do "modelo" (apenas mock/fallback). */
export const CONFIDENCE_FLOOR = 0.6;
export const CONFIDENCE_CEILING = 0.97;
export const CONFIDENCE_STEP = 0.07;

/**
 * Calibração adicional por tipo de sinal (somente heurística).
 * Ex.: pedidos diretos de imagem recebem peso extra, pois são o gatilho mais
 * explícito.
 */
