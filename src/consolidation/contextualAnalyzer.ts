 ...
 *
 * Portado de `app-diana-monitoring/src/pipeline/contextualAnalyzer.ts`.
 * Avalia conteúdo, sequência, frequência, escalada e combinação de sinais.
 * Ver `docs/regras-de-negocio.md` §5.
 */
import type { ContextualFactor, ConversationFeatures, DetectedSignal } from "@diana/contracts";
 ...
 *   fator sequência recai na simples co-ocorrência.
 */
